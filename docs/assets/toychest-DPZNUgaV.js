var Ge=Object.defineProperty;var Re=(s,e,r)=>e in s?Ge(s,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[e]=r;var u=(s,e,r)=>Re(s,typeof e!="symbol"?e+"":e,r);import{i as qe,c as ve,a as Te,b as P,d as O,w as H,g as xe,r as Pe,e as Ae}from"./device-CAsdAK37.js";import{c as ge,a as _e,b as Me,d as Oe,O as We,g as Ue}from"./orbitControls-D071pLfL.js";class C{constructor(e=0,r=0,t=0){this.data=new Float32Array([e,r,t])}get x(){return this.data[0]}set x(e){this.data[0]=e}get y(){return this.data[1]}set y(e){this.data[1]=e}get z(){return this.data[2]}set z(e){this.data[2]=e}set(e,r,t){return this.data[0]=e,this.data[1]=r,this.data[2]=t,this}copy(e){return this.data[0]=e.data[0],this.data[1]=e.data[1],this.data[2]=e.data[2],this}clone(){return new C(this.x,this.y,this.z)}add(e){return this.data[0]+=e.data[0],this.data[1]+=e.data[1],this.data[2]+=e.data[2],this}sub(e){return this.data[0]-=e.data[0],this.data[1]-=e.data[1],this.data[2]-=e.data[2],this}scale(e){return this.data[0]*=e,this.data[1]*=e,this.data[2]*=e,this}dot(e){return this.data[0]*e.data[0]+this.data[1]*e.data[1]+this.data[2]*e.data[2]}cross(e){const r=this.data[0],t=this.data[1],i=this.data[2],n=e.data[0],o=e.data[1],a=e.data[2];return this.data[0]=t*a-i*o,this.data[1]=i*n-r*a,this.data[2]=r*o-t*n,this}length(){return Math.sqrt(this.dot(this))}lengthSq(){return this.dot(this)}normalize(){const e=this.length();return e>0&&this.scale(1/e),this}static cross(e,r,t=new C){return t.data[0]=e.y*r.z-e.z*r.y,t.data[1]=e.z*r.x-e.x*r.z,t.data[2]=e.x*r.y-e.y*r.x,t}static dot(e,r){return e.x*r.x+e.y*r.y+e.z*r.z}}function pe(s,e){const r=s/e.length;let t=0,i=0,n=0;for(const o of e){const a=o[0],g=o[1],f=o[2];t+=r*(g*g+f*f),i+=r*(a*a+f*f),n+=r*(a*a+g*g)}return new C(t,i,n)}function Fe(s,e){const r=.4*s*e*e;return new C(r,r,r)}const De=`// Shared WGSL utilities for WebGPU Physics
